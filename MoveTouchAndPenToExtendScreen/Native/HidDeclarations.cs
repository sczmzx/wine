...
namespace MoveTouchAndPenToExtendScreen.Native
{
    ...
    public sealed partial class HidNativeApi
    {
        ...
        static public extern int HidP_SetUsageValue(HidReportType ReportType, ushort UsagePage, short LinkCollection, ushort Usage, ref int UsageValue, IntPtr PreparsedData, IntPtr Report, int ReportLength);
        ...
        /// HIDP_STATUS_USAGE_NOT_FOUND</returns>
        [DllImport("hid.dll", SetLastError = true)]
        static public extern int HidP_SetScaledUsageValue(HidReportType ReportType, ushort UsagePage, short LinkCollection, ushort Usage, ref int UsageValue, IntPtr PreparsedData,IntPtr Report, int ReportLength);
        //static public extern int HidP_SetScaledUsageValue([MarshalAs(UnmanagedType.U2)]HidReportType ReportType, ushort UsagePage, short LinkCollection, ushort Usage,ref int UsageValue, IntPtr PreparsedData, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 7)] IntPtr Report, int ReportLength);
